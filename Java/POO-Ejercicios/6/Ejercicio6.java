...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        String decision;
        System.out.println("Defina capacidad maxima de cafetera");
        c1.setCapacidadMaxima(leer.nextInt());
        System.out.println("Defina cantidad de cafe que hay en la cafetera");
        c1.setCantidadActual(leer.nextInt());
        do {
            System.out.println("Que desea hacer?");
            System.out.println("");
            System.out.println("Llenar cafetera(LL)");
            System.out.println("Servir taza(SE)");
            System.out.println("Vaciar cafetera(V)");
            System.out.println("Agregar cafe a la cafetera(A)");
            decision = leer.next();
            switch (decision) {
                case "LL":
                    c1.llenarCafetera();
